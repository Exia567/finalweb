...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-body-tertiary sticky-top bg-dark-subtle">
        <div class="container">
            <a class="navbar-brand" href="">K-zone admin</a>
    ...
    <footer class="text-center p-1 bg-dark-subtle footer fixed-bottom">
        <div>
            <a href="https://www.instagram.com/udinusofficial"><i class="bi bi-instagram h5 p-1 text-dark"></i></a>
            <a href="https://twitter.com/udinusofficial"><i class="bi bi-twitter h5 p-1 text-dark"></i></a>
            <a href="https://wa.me/+62812685577"><i class="bi bi-whatsapp h5 p-1 text-dark"></i></a>
        </div>
        <div class="small">Mahardika &copy; 2025</div>
    </footer>
    </footer>
    <!-- footer end -->
